...
| Focus | Issue | Notes |
|---|---|---|
| Typed domain models | [#6](https://github.com/itprodirect/cat-loss-war-room/issues/6) | Ready for closeout review: intake/query, pack, citation/export, graph/version, issue/authority, run/retrieval, review/export graph-linkage, schema-versioned runtime cache-envelope, and typed Run Timeline / Evidence Board / Issue Workspace / Memo Composer / Export History read-model slices are landed against the canonical schema in `#24` |
