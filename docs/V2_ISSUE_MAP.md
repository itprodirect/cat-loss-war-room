...
| Scenario fixture suite | [#8](https://github.com/itprodirect/cat-loss-war-room/issues/8) | Four committed scenario directories now cover Florida, Texas, and Louisiana and feed `#27`; a first deterministic golden snapshot gate now covers output structure, source mix, case counts, citation summaries, and coverage metadata; the next step is broader fixture breadth |
