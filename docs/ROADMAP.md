...
- 455 tests are passing on the supported verify path.
...
- Issue [#12](https://github.com/itprodirect/cat-loss-war-room/issues/12) has first adapter slices landed for caselaw issue `#94`, carrier issue `#96`, weather issue `#98`, and citation-verify issue `#103` / PR `#105`. Broader dedupe/provenance hardening, persistence, dashboards, API integration, review workflow, provenance-through-edits, and any claim that the full V2 evidence graph is complete remain pending.
...
- V2 implementation work now has first narrow issue `#12` evidence-adapter slices for weather, carrier, caselaw, and citation-verification output; broader provenance/dedupe, product workflow, API, UI, persistence, review, and pilot operationalization work remains pending.
...
1. [#12](https://github.com/itprodirect/cat-loss-war-room/issues/12) Review remaining evidence/provenance follow-ups after the landed weather, carrier, caselaw, and citation-verification adapter slices
...
- The main cleanup is scope clarity, not deletion:
  ...
  - `#12` should explicitly implement against the canonical schema defined in `#24`; weather, carrier, caselaw, and citation-verification adapter slices have landed, but the full evidence/provenance lane is still open.
...
- [#12](https://github.com/itprodirect/cat-loss-war-room/issues/12) Review remaining follow-ups after all current evidence-producing source families have named adapters, then choose a deterministic dedupe helper, provenance link hardening, citation-quality fixture regression under `#13` / `#14`, or a docs-only issue-12 closeout/status map.
...
- [#12](https://github.com/itprodirect/cat-loss-war-room/issues/12) Evidence normalization + provenance beyond the landed weather, carrier, caselaw, and citation-verification adapters
