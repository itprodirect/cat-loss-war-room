...
- The curated scenario registry now has three offline-ready fixture-backed benchmarks, Milton/Pinellas/Citizens, Ida/Orleans/Lloyd's, and Texas hail/Tarrant/Allstate HO-B, while the Texas DP-3 matching fixture lane remains eval-intake-backed.
...
2. [#8](https://github.com/itprodirect/cat-loss-war-room/issues/8) Multi-jurisdiction fixture suite + snapshots (golden snapshot gate, Texas hail registry promotion, fixture-seeding process, and next-candidate audit landed; broader breadth still open)
...
- [#8](https://github.com/itprodirect/cat-loss-war-room/issues/8) Multi-jurisdiction fixture suite + snapshots (golden snapshot gate, Texas hail registry promotion, fixture-seeding process, and next-candidate audit landed; broader breadth still open)
