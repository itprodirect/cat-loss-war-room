...
- [ ] [#9](https://github.com/itprodirect/cat-loss-war-room/issues/9) expanded CI gates (offline fixture smoke plus golden snapshot gate, release-scorecard artifact emission plus validation, supported local verify-evidence workflow, and categorized quality-gate artifacts landed; broader e2e/security layering still needed)
