...
- [ ] [#8](https://github.com/itprodirect/cat-loss-war-room/issues/8) scenario fixtures + snapshots (five committed scenario directories now cover Florida, Texas, and Louisiana; all five committed fixture lanes are registry-backed, and the golden snapshot gate plus fixture-seeding process/guard landed; issue remains open for maintainer closeout review)
