...
- [ ] [#7](https://github.com/itprodirect/cat-loss-war-room/issues/7) retrieval contracts (provider seam + notebook retrieval-state + citation-verify + deterministic retrieval-task timing + failure-mode normalization slices landed)
- [ ] [#8](https://github.com/itprodirect/cat-loss-war-room/issues/8) scenario fixtures + snapshots (four committed scenario directories now cover Florida, Texas, and Louisiana; the first deterministic golden snapshot gate landed; broader fixture breadth still needed)
