...
- [ ] [#8](https://github.com/itprodirect/cat-loss-war-room/issues/8) scenario fixtures + snapshots (four committed scenario directories now cover Florida, Texas, and Louisiana; the golden snapshot gate, Texas hail registry promotion, fixture-seeding process/guard, and next-candidate audit landed; broader fixture breadth still needed)
