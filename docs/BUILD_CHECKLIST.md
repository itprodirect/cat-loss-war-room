...
- [ ] [#8](https://github.com/itprodirect/cat-loss-war-room/issues/8) scenario fixtures + snapshots (four committed scenario directories now cover Florida, Texas, and Louisiana; the first deterministic golden snapshot gate, second registry-backed offline scenario, and fixture-seeding process/guard landed; broader fixture breadth still needed)
