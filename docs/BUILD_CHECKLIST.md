...
- [ ] [#8](https://github.com/itprodirect/cat-loss-war-room/issues/8) scenario fixtures + snapshots (four committed scenario directories now cover Florida, Texas, and Louisiana; all four committed fixture lanes are now registry-backed, and the golden snapshot gate plus fixture-seeding process/guard landed; broader fixture breadth still needed)
