...
- [ ] [#9](https://github.com/itprodirect/cat-loss-war-room/issues/9) expanded CI gates (offline fixture smoke plus golden snapshot gate, release-scorecard artifact emission plus validation, and the supported local verify-evidence workflow landed; broader CI layering still needed)
