...
- [ ] [#6](https://github.com/itprodirect/cat-loss-war-room/issues/6) typed domain models (slices 1-11 complete: intake/query + module packs + citation/export contracts + graph/version envelopes + issue/authority contracts + run/retrieval lifecycle contracts + review/export graph-linkage contracts + schema-versioned runtime cache envelopes + Evidence Board, Issue Workspace, and Memo Composer read-model contracts)
