...
- [ ] [#9](https://github.com/itprodirect/cat-loss-war-room/issues/9) expanded CI gates (offline fixture smoke plus golden snapshot gate, release-scorecard artifact emission plus validation, supported local verify-evidence workflow, categorized quality-gate artifacts, and an offline security hygiene gate landed; broader integration/e2e layering still needed)
