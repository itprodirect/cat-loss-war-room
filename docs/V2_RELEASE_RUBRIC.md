...
python -m war_room.release_scorecard \
  ...
  --verification-summary "449 passed"
```
...
- `#12` and `#13`: broader evidence normalization, citation-verify adaptation, and case-law quality
