...
| Tests | 159 passing, package-installed, no network calls in tests |
...
| Retrieval contracts (#7) | First slice landed: provider protocol, task-bound helpers, and Exa compatibility contract tests |
...
- #7 retrieval provider abstraction and contracts (first protocol/contract-test slice landed)
