...
- Last validated: 2026-05-18 via `git diff --check` and `python -m pytest -q` (`432 passed in 33.50s`). Previous issue `#88` release-evidence validation remains recorded in session 123.
