...
tests/              # pytest test suite (322 tests, no network)
...
## Current phase
v0-demo shipped, issues #22, #23, #24, and #6 are complete, and active V2 execution work is now concentrated in broader #27 CI/pilot operationalization plus the remaining #7 to #9 foundation slices. Cells 0-7 remain stable and CI runs package-installed tests.
...
Next priority: continue the remaining #8 fixture breadth and #9 quality-gate work before downstream implementation in #10 onward.
