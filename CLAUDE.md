...
tests/              # pytest test suite (484 tests, no network)
...
Next priority: after the post-hardening docs wrap-up, pause implementation and review the remaining #12 roadmap. The likely next child should be a provenance-safe dedupe integration plan with `old_id -> retained_id` mapping, deterministic dedupe integration into audit snapshot assembly, provenance link hardening across memo claims / evidence clusters / review events, or citation-quality fixture regression under #13/#14. Broader #27 scorecard/rubric operationalization and explicitly scoped #10/#11 follow-ups remain available after that. Issues #64 and #65 are closed hygiene follow-ups.
